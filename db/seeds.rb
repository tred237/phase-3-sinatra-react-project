...
Routine.create(day: 'Monday', sets: rand(3..5), reps: rand(8..15), user_id: 1, exercise_id: 1)
Routine.create(day: 'Monday', sets: rand(3..5), reps: rand(8..15), user_id: 1, exercise_id: 3)
Routine.create(day: 'Monday', sets: rand(3..5), reps: rand(8..15), user_id: 1, exercise_id: 4)
Routine.create(day: 'Wednesday', sets: rand(3..5), reps: rand(8..15), user_id: 2, exercise_id: 2)
Routine.create(day: 'Wednesday', sets: rand(3..5), reps: rand(8..15), user_id: 2, exercise_id: 4)
Routine.create(day: 'Wednesday', sets: rand(3..5), reps: rand(8..15), user_id: 2, exercise_id: 5)
Routine.create(day: 'Sunday', sets: rand(3..5), reps: rand(8..15) , user_id: 2, exercise_id: 2)
Routine.create(day: 'Sunday', sets: rand(3..5), reps: rand(8..15), user_id: 2, exercise_id: 1)
Routine.create(day: 'Sunday', sets: rand(3..5), reps: rand(8..15), user_id: 2, exercise_id: 3)
Routine.create(day: 'Friday', sets: rand(3..5), reps: rand(8..15), user_id: 1, exercise_id: 2)
